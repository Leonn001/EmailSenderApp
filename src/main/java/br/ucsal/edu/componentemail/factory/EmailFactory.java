...
public abstract class  EmailFactory {
    ...
    public static Email createRegisterEmail(String emailFrom, String passwordEmailFrom, List<String> emailTo) {
    ...
    public static Email createPasswordRecoveryEmail(String emailFrom, String passwordEmailFrom, List<String> emailTo) {
        String subject = "Recuperação de Senha";
        String messageBody = "Olá, Você solicitou a recuperação de sua senha! Atenciosamente, EmailSender";
        return new Email(emailFrom,passwordEmailFrom,emailTo, subject, messageBody);
    }

    public static Email createAccountUpdateEmail(String emailFrom, String passwordEmailFrom, List<String> emailTo) {
    ...
    public static Email createOrderNotificationEmail(String emailFrom, String passwordEmailFrom, List<String> emailTo) {
